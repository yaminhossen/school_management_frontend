...
import * as branch_class_fee_discounts_model from './branch_class_fee_discounts_model';
...
interface models {
    BranchClassFeeDiscountsModel: typeof branch_class_fee_discounts_model.DataModel;
...
const db = async function (): Promise<models> {
    const BranchClassFeeDiscountsModel =
        branch_class_fee_discounts_model.init(sequelize);
    ...
    BranchClassFeeDiscountsModel.hasOne(BranchClassesModel, {
        sourceKey: 'branch_class_id',
        foreignKey: 'id',
        as: 'class',
    });

    BranchClassFeeDiscountsModel.hasOne(BranchClassFeesModel, {
