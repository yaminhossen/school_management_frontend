...
# API_URL="http://127.0.0.1:5003/api/v1/user-branch-admins?orderByCol=id&orderByAsc=true&show_active_data=true&paginate=10&page=0"
# response=$(curl -s "$API_URL")
...
# API_URL="http://127.0.0.1:5003/api/v1/user-parents?orderByCol=id&orderByAsc=true&show_active_data=true&paginate=10&page=0"
# response=$(curl -s "$API_URL")
...
# API_URL="http://127.0.0.1:5003/api/v1/user-staffs?orderByCol=id&orderByAsc=true&show_active_data=true&paginate=10&page=0"
# response=$(curl -s "$API_URL")
...
# API_URL="http://127.0.0.1:5003/api/v1/user-teachers?orderByCol=id&orderByAsc=true&show_active_data=true&paginate=10&page=0"
# response=$(curl -s "$API_URL")
