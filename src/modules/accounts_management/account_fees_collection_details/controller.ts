...
import student_payment_historoy from './services/student_payment_history';
...
export default function (fastify: FastifyInstance) {
    return {
        ...
        student_payment_historoy: async function (
            req: FastifyRequest,
            res: FastifyReply,
        ) {
            let data = await student_payment_historoy(fastify, req);
            res.code(data.status).send(data);
        },
