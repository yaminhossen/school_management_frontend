                        ...
                        <div className="single-info-details">
                            ...
                            <div className="item-content">
                                ...
                                <ul className="section_naviagation">
                                    <li>
                                        <Link to="/branch-class-subjects/details/3/fees">
                                            Fees
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/branch-class-subjects/details/3/fee-types">
                                            Fee Types
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/branch-class-subjects/details/3/fee-discounts">
                                            Fee Discounts
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="/branch-class-subjects/details/3/fee-waivers">
                                            Fee Waivers
                                        </Link>
                                    </li>
                                </ul>
