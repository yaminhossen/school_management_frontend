                ...
                <section className="class_schedule_area">
                    <div className="container">
                        ...
                        <div className="class_schedule_content">
                            {/* Display Class and Exam Info */}
                            {(s_class || exam) && (
                                <div className="schedule_info" style={{ 
                                    marginBottom: '20px', 
                                    padding: '15px', 
                                    backgroundColor: '#02020296', 
                                    borderRadius: '5px',
                                    display: 'flex',
                                    gap: '30px'
                                }}>
                                    {s_class && (
                                        <div style={{ fontSize: '16px', fontWeight: 'bold' }}>
                                            ...
                                            <span style={{ color: '#007bff' }}>{s_class.name}</span>
                                        </div>
                                    )}
                                    {exam && (
                                        <div style={{ fontSize: '16px', fontWeight: 'bold' }}>
                                            <span style={{ color: '#333' }}>Exam: </span>
                                            <span style={{ color: '#28a745' }}>{exam.title}</span>
                                        </div>
                                    )}
                                </div>
                            )}
