...
import teacher_overall_evaluations_slice from '../views/pages/teacher_kpi_management/teacher_overall_evaluations/config/store';
...
// import students_slice from '../views/pages/class_management/students/config/store';
...
const store = configureStore({
    reducer: {
        ...
        teacher_overall_evaluations: teacher_overall_evaluations_slice.reducer,
        teacher_evaluation_criterias:
