!(function (t, e) {
    ...
    'undefined' != typeof window &&
        ...
        ((rn = new Date()),
        (an = localStorage.getItem('swal-initiation'))
            ? 3 < (rn.getTime() - Date.parse(an)) / 864e5 &&
              setTimeout(function () {
            ...
            : localStorage.setItem('swal-initiation', ''.concat(rn))),
    s(un.prototype, sn),
    s(un, oe),
